...
<head>
    ...
    <link rel="icon" href="img/logo.png" style="width: 200%" type="image/ico" />
        ...
        <div class="row align-items-center bg-white py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="index.html" class="navbar-brand p-0 d-none d-lg-block">
                    <h1 class="m-0 display-4 text-uppercase text-primary"> <img src="img/logo.png" style="width: 120px;" />
                    </h1>
                </a>
            </div>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="category.html" class="nav-item nav-link">Popular</a>
                    <!-- <a href="single.html" class="nav-item nav-link">Single News</a> -->
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Category</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="#" class="dropdown-item">BUSINESS</a>
                            <a href="#" class="dropdown-item">CARGO</a>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center bg-white border border-left-0" style="width: calc(100% - 180px); padding-right: 100px;">
                            <div class="text-truncate"><a class="text-secondary text-uppercase font-weight-semi-bold" href="">DUKUNG KTT KE-43 ASEAN, JAS TANGANI 20 PENERBANGAN VVIP DELEGASI ENAM NEGARA PESERTA
                                </a></div>
                            <div class="text-truncate"><a class="text-secondary text-uppercase font-weight-semi-bold" href="">LATIHAN MILITER GABUNGAN ‘SUPER GARUDA SHIELD 2023’ PERCAYAKAN JAS TANGANI KONTINGEN AMERIKA</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/logo.jpeg" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            ...
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">PENGUMUMAN RINGKASAN RISALAH RAPAT UMUM PEMEGANG SAHAM LUAR BIASA PT JASA ANGKASA SEMESTA TBK</h1>
