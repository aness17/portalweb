                        ...
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px">
                            ...
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    ...
                                    <span class="text-body"><small>Cengkareng, 4 Agustus 2023</small></span>
                                </div>
                                <a class="h6 m-0 text-secondary text-uppercase font-weight-bold news-truncate" href="<?= base_url('users') ?>">DUKUNG KTT KE-43 ASEAN, JAS TANGANI 20 PENERBANGAN VVIP DELEGASI ENAM NEGARA PESERTA</a>
                                <span class="text-body"><small>Dalam rangka mendukung Konferensi Tingkat Tinggi (KTT) ke-43 ASEAN yang akan diselenggarakan di Jakarta ...</small></span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px">
                            <img class="img-fluid" src="<?= base_url('user/') ?>img/news-110x110-3.jpg" alt="" />
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                ...
                                <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="">DUKUNG KTT KE-43 ASEAN, JAS TANGANI 20 PENERBANGAN VVIP ...</a>
                                <span class="text-body"><small>Dalam rangka mendukung Konferensi Tingkat Tinggi (KTT) ke-43 ASEAN yang akan diselenggarakan di Jakarta ...</small></span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px">
